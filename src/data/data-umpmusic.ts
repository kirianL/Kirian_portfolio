import umpMusicImg from "@/assets/ImagesProjects/UMP-music/Hero.webp";

export const umpMusicDetails = {
  ES: {
    slug: "ump-music",
    name: "UMP Music",
    year: "2024",
    ...
    image: umpMusicImg,
    description:
      "Landing page de alto impacto visual y rendimiento optimizado para UMP.",
    longDescription:
      "La plataforma sirve como el punto central de presentación para la marca, sus artistas, noticias y enlaces a redes sociales. Se busca una estética 'premium/brutalist' que refleje la identidad urbana y moderna del sello discográfico.",
    overview:
      "Punto central de presentación para la marca, priorizando la conversión de visitantes en seguidores y una experiencia inmersiva.",
    role: "Diseño UI/UX · Desarrollo Frontend · Optimización",
    stack: ["Next.js 16", "TypeScript", "Tailwind CSS", "Supabase"],
    objective:
      "Crear una landing page de alto impacto visual y rendimiento optimizado, priorizando la conversión y ofreciendo una experiencia inmersiva tanto en móvil como en escritorio.",
    concept: [
      "Estética Cinemática y Editorial",
      "Minimalismo Brutalista",
      "Atmósfera Underground Sofisticada",
      "Uso predominante de fondos oscuros con acentos neón",
    ],
    ux: [
      "Diseño Mobile-First",
      "Navegación Intuitiva y fluida",
      "Micro-interacciones y feedback visual instantáneo",
    ...
    challenges:
      "Equilibrio entre una estética rica en imágenes y efectos y un rendimiento óptimo (LCP/CLS). Adaptación de layouts complejos (grids) a dispositivos móviles.",
    technical: [
      "Next.js 16 (App Router) y Server Components",
      "TypeScript para robustez",
      "Tailwind CSS para estilos y sistema de diseño",
      "Supabase como Backend/DB",
      "Carga de imágenes optimizada",
    ],
    credits: {
      name: "Equipo UMP Music",
      link: "#",
    },
    link: "https://ump-landing-page.vercel.app/es",
  },
  EN: {
    slug: "ump-music",
    name: "UMP Music",
    ...
    link: "https://ump-landing-page.vercel.app/en",
  },
  PT: {
    slug: "ump-music",
    name: "UMP Music",
    ...
    concept: [
      ...
      "Minimalismo Brutalista",
      "Atmosfera Underground Sofisticada",
      "Uso predominante de fundos escuros com acentos neon",
    ],
    ux: [
      "Design Mobile-First",
    ...
    link: "https://ump-landing-page.vercel.app/pt",
  },
};
